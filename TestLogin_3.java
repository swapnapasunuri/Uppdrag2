...
///////////////////////////////////////////////////////////
        ...
        //System.out.println("*********" + price_list.toString());
...
////////////////////////////////////////////////////////
        ...
        for (WebElement element : items_available) {
            String myText = element.findElement( By.className("inventory_item_name")).toString();
...
////////////////////////////////////////////////////////
// @Test
//@DisplayName("Check the total sum in the basket and compare it to our sum")
////////////////////////////////////////////////////////
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS) ;
        //WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(10));

        //WebElement w1= driver.findElement(By.id("i"));
...
////////////////////////////////////////////////////////
        ...
        //3 test cases could be developed here: One proceed, one cancel, one assert name+sum
    }
